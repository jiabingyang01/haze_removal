...
- [Haze Removal: Dark Channel Prior with AVX SIMD Optimization](#haze-removal-dark-channel-prior-with-avx-simd-optimization)
  - [📑 目录](#-目录)
  - [🌟 项目简介](#-项目简介)
    - [核心特性](#核心特性)
  - [📐 算法原理](#-算法原理)
    - [1. 大气散射模型](#1-大气散射模型)
    - [2. 暗通道先验（Dark Channel Prior）](#2-暗通道先验dark-channel-prior)
    - [3. 大气光值估计](#3-大气光值估计)
    - [4. 透射率估计](#4-透射率估计)
    - [5. 导向滤波精化透射率](#5-导向滤波精化透射率)
    - [6. 场景辐射恢复](#6-场景辐射恢复)
  - [⚡ SIMD 加速优化](#-simd-加速优化)
    - [优化模块一览](#优化模块一览)
    - [最小值滤波 SIMD 优化示例](#最小值滤波-simd-优化示例)
  - [📁 项目结构](#-项目结构)
    - [源码模块说明](#源码模块说明)
  - [🔧 环境依赖](#-环境依赖)
  - [🚀 编译与运行](#-编译与运行)
